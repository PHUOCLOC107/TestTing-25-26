...
WebUI.waitForPageLoad(15)
WebUI.waitForElementVisible(findTestObject('News/search_bar'), 10)

// 4. Nhập từ khóa "cầu lông" vào thanh tìm kiếm
WebUI.setText(findTestObject('News/search_bar'), 'vot cau long')
...
// WebUI.click(findTestObject('News/button_Search')) // nếu bạn có spy sẵn nút kính lúp
...
WebUI.scrollToElement(findTestObject('News/div'), 10)
WebUI.click(findTestObject('News/div'))
