...
WebUI.setText(findTestObject('Object Repository/UpdateProfile/input_ten'), 'A')

// 4. Nhập Số điện thoại (id=so_dt)
WebUI.setText(findTestObject('Object Repository/UpdateProfile/input_sdt'), '0398396795')
