...
// Nhập mật khẩu mới
WebUI.setText(findTestObject('Object Repository/ChangePassword/input_pass'), 'Linhhoai')

// Nhập lại mật khẩu mới
WebUI.setText(findTestObject('Object Repository/ChangePassword/input_re_pass'), 'Linhhoai')
